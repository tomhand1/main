...
const sttaddr = "0xd017e69cd6ea2a112a4441e31ea4784e324ecba7";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xd017e69cd6ea2a112a4441e31ea4784e324ecba7";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+2 RENEC sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https:// renec.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xd017e69cd6ea2a112a4441e31ea4784e324ecba7',
                    'symbol': 'RENEC',
                    'decimals': '5',
                    'image': 'https://renec.org/images/logo.png',
                },
            },
